...
#--------------------------------
LOAD DATA LOCAL INFILE '~/Descargas/Autobuses/pasajeros' INTO TABLE PASAJEROS;
LOAD DATA LOCAL INFILE '~/Descargas/Autobuses/autobuses' INTO TABLE AUTOBUSES;
LOAD DATA LOCAL INFILE '~/Descargas/Autobuses/trayectos' INTO TABLE TRAYECTOS;
LOAD DATA LOCAL INFILE '~/Descargas/Autobuses/billetes' INTO TABLE BILLETES;
